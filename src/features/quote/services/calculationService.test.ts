...
describe('calculationService', () => {
  ...
  describe('calculateItemSurge', () => {
    it('should return no surge cost for a standard small package', () => {
      // 10kg, 30x30x30
      const result = calculateItemSurge(30, 30, 30, 10, PackingType.CARTON, 0);
    ...
    it('should apply AHS Weight surge for package > 25kg', () => {
      // 30kg, 30x30x30
      const result = calculateItemSurge(30, 30, 30, 30, PackingType.CARTON, 0);
    ...
    it('should apply AHS Dimension surge for Length > 122cm', () => {
      // 10kg, 130x30x30
      const result = calculateItemSurge(130, 30, 30, 10, PackingType.CARTON, 0);
    ...
    it('should apply Large Package Surcharge logic correctly', () => {
      ...
      const result = calculateItemSurge(100, 60, 60, 20, PackingType.CARTON, 0);
    ...
    it('should apply heavy penalty for Over Max Limits', () => {
        // Weight > 70kg
        const result = calculateItemSurge(50, 50, 50, 75, PackingType.CARTON, 0);
