  ...
  return (
      <div className={`grid ${hideMargin ? 'grid-cols-2' : 'grid-cols-3'} gap-3 sm:gap-4`}>
        ...
        <div className={metricCardClass}>
            ...
            <span className="block text-sm sm:text-base font-bold text-brand-blue-600 dark:text-brand-blue-400">{formatNum(result.billableWeight)} <span className="text-xs font-normal text-gray-400">kg</span></span>
        </div>
        {!hideMargin && (
          <div className={metricCardClass}>
