...
export const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'landing.subtitle':
      'The express freight quoting engine built for forwarding partners. Calculate Door-to-Door costs with real-time exchange rates and FSC — instantly.',
    ...
    'landing.verifiedCarriers': 'Verified Rate Structure',
    'landing.verifiedCarriers.desc':
      'Accurate pricing based on actual carrier rate structures. All-in-one quotes including packing, add-on services, and Door-to-Door costs.',
    'landing.liveRates': 'Live Rate Sync',
    'landing.globalPorts': '190+ Countries Covered',
    'landing.stat.carriers': 'Express Carriers',
    'landing.stat.countries': 'Destinations',
    'landing.stat.calculation': 'Avg. Quote Time',
    ...
    'auth.magicLink.sentBody':
      "If that email exists in our system, we've sent a sign-in link. The link expires in 15 minutes.",
    ...
    'schedule.effectiveFrom': 'Effective From',
    'schedule.effectiveTo': 'Effective To',
  ...
  ja: {
    ...
    'landing.subtitle':
      'フォワーディングパートナー向け国際エクスプレス見積システム。リアルタイム為替レートとFSCを反映し、Door-to-Door運賃を即時算出します。',
    'landing.getStarted': '無料で始める',
    'landing.featuresLabel': 'フォワーダー向け機能',
    'landing.featuresTitle': 'ネットワークパートナーのためのスマート見積ソリューション',
    'landing.instantQuotes': '即時運賃見積',
    'landing.instantQuotes.desc':
      'リアルタイム為替レートと燃料サーチャージを反映し、Door-to-DoorおよびDoor-to-Air料金を即座に計算。キャリア比較で最適運賃を確認できます。',
    'landing.accurateBreakdown': '透明な費用構造',
    'landing.accurateBreakdown.desc':
      '国際運賃、FSC、梱包費、付加サービスを項目別に透明に分解し、正確な見積を提供します。（関税・通関費用は別途）',
    'landing.verifiedCarriers': '検証済み料金体系',
    'landing.verifiedCarriers.desc':
      '実際のキャリア料金構造に基づく正確な価格算出。梱包費・付加サービスを含むオールインワン見積を提供します。',
    'landing.liveRates': 'リアルタイム料金連動',
    'landing.globalPorts': '190+ヶ国カバー',
    'landing.stat.carriers': 'エクスプレスキャリア',
    'landing.stat.countries': '対応国',
    'landing.stat.calculation': '平均見積時間',
    ...
    'auth.networkDesc.WCA':
      'World Cargo Alliance — 195ヶ国12,500+拠点、世界最大のフォワーダーネットワーク',
    ...
    'auth.magicLink.title': 'マジックリンクでログイン',
    'auth.magicLink.description': '安全なログインリンクをメールでお送りします。',
    'auth.magicLink.emailLabel': 'メールアドレス',
    'auth.magicLink.sending': '送信中...',
    'auth.magicLink.send': 'ログインリンクをメールで受け取る',
    'auth.magicLink.sent': 'メールをご確認ください',
    'auth.magicLink.sentBody':
      'そのメールが登録されていれば、ログインリンクを送信しました。リンクは15分後に期限切れとなります。',
    'auth.magicLink.verifying': 'ログイン中...',
    'auth.magicLink.invalidLink': '無効なリンクです。',
    'auth.magicLink.expired': 'リンクの有効期限が切れたか、既に使用されています。',
    'auth.magicLink.failed': 'ログイン失敗',
    'auth.magicLink.backToLogin': 'ログインに戻る',
    'auth.magicLink.emailRequired': 'メールアドレスを入力してください。',
    'auth.magicLink.requestFailed': 'ログインリンクの送信に失敗しました。もう一度お試しください。',
    ...
    'calc.costBasis.disclaimer':
      '上記金額にはすべての推定追加料金が含まれています。実際の請求額は実測に基づいて変動する場合があります。',
    ...
    'calc.service.surcharge.notice.body':
      '割増料金はUPS/DHL公式発表に基づき管理者が手動更新しています。リアルタイム自動反映ではないため、見積確定前に公式ページで最新料率をご確認ください。',
    ...
    'dashboard.jetFuel.fscNote':
      'UPS FSCはこの価格を基準に2週間後に適用されます（セント単位で四捨五入）',
    ...
    'schedule.effectiveFrom': '有効開始日',
    'schedule.effectiveTo': '有効終了日',
    'schedule.remarks': '備考',
