...
export const translations: Record<Language, Record<string, string>> = {
  ko: {
     ...
     // Landing Page
     'landing.title.main': '190개국 항공·해상 운임,',
     'landing.title.sub': '1초 만에 견적 완료.',
     'landing.subtitle': 'WCA · MPL · EAN · JCtrans 네트워크 파트너를 위한 국제 물류 견적 시스템. UPS, DHL, EMAX 연동으로 Door-to-Door 운임을 즉시 산출합니다.',
     ...
     'landing.instantQuotes.desc': 'UPS, DHL, EMAX 운임을 동시에 비교. Door-to-Door, Door-to-Airport 요금을 실시간 환율과 FSC를 반영하여 즉시 계산합니다.',
  ...
  en: {
    ...
    'landing.subtitle': 'The quoting engine built for WCA, MPL, EAN & JCtrans network partners. Compare UPS, DHL and EMAX rates with real-time FSC, packaging and Door-to-Door costs in one click.',
    ...
    'landing.instantQuotes.desc': 'Compare UPS, DHL and EMAX rates side by side. Calculates Door-to-Door and Door-to-Airport costs with live exchange rates and fuel surcharges.',
  ...
  cn: {
    ...
    // Landing Page
    'landing.title.main': '190+国家空运海运运费，',
    'landing.title.sub': '1秒即时报价。',
    'landing.subtitle': '专为WCA、MPL、EAN、JCtrans网络合作伙伴打造的国际物流报价系统。整合UPS、DHL、EMAX运费，即时生成门到门报价。',
    'landing.getStarted': '免费开始',
    'landing.featuresLabel': '货代专属核心功能',
    'landing.featuresTitle': '全球货代信赖的报价引擎',
    'landing.instantQuotes': '多承运商实时比价',
    'landing.instantQuotes.desc': '同时比较UPS、DHL、EMAX运费。结合实时汇率和燃油附加费，即时计算门到门和门到机场费率。',
  ...
  ja: {
    ...
    // Landing Page
    'landing.title.main': '190ヶ国の航空・海上運賃を、',
    'landing.title.sub': '1秒で見積完了。',
    'landing.subtitle': 'WCA・MPL・EAN・JCtransネットワークパートナー向け国際物流見積システム。UPS、DHL、EMAXを統合し、Door-to-Door運賃を即時算出します。',
    ...
    'landing.instantQuotes.desc': 'UPS、DHL、EMAXの運賃を同時比較。リアルタイム為替レートと燃料サーチャージを反映し、Door-to-DoorおよびDoor-to-Air料金を即座に計算します。',
