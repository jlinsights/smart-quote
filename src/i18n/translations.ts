...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'calc.service.pickup.label': 'Extra Cost Pick up in Seoul (KRW)',
    'calc.service.pickup.hint': 'Enter additional cost if cargo pick-up in Seoul is required.',
    'calc.service.pickup.none': 'No pickup required',
    'calc.service.pickup.guide.title': '📦 Consolidation Cut-off Guide',
    'calc.service.pickup.guide.same': 'Pick-up before 14:00 → Arrived by 18:00 same day',
    'calc.service.pickup.guide.next': 'Pick-up after 14:00 → Arrived by 10:00 next day',
    'calc.service.pickup.same.label': 'Same-day Consol',
    'calc.service.pickup.next.label': 'Next-day Consol',
    'calc.service.pickup.table.district': 'District',
    'calc.service.pickup.table.cost': 'Pick-up Fee',
