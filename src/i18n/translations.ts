...
export const translations: Record<Language, Record<string, string>> = {
  ko: {
     ...
     'landing.subtitle': 'WCA · MPL · EAN · JCtrans 네트워크 파트너를 위한 한국(ICN)발 수출 특송 견적 시스템. UPS, DHL, E-MAX 연동으로 Door-to-Door 운임을 즉시 산출하며, 캐리어는 지속 확장 중입니다.',
     ...
     'landing.instantQuotes.desc': 'UPS, DHL, E-MAX 운임을 동시에 비교하고, 캐리어는 지속 추가됩니다. Door-to-Door, Door-to-Airport 요금을 실시간 환율과 FSC를 반영하여 즉시 계산합니다.',
     'landing.accurateBreakdown': '투명한 비용 구조',
     'landing.accurateBreakdown.desc': '국제 운임, 유류할증료(FSC), 포장비, 부가서비스까지 항목별 세분화. 마진 설정으로 고객 제안가를 한 번에 산출합니다. (관세/통관 비용은 별도)',
  ...
  en: {
    ...
    // Landing Page
    'landing.title.main': 'Express Freight Quotes',
    'landing.title.sub': 'from Korea (ICN), Instantly.',
    'landing.subtitle': 'The quoting engine built for WCA, MPL, EAN & JCtrans network partners. Compare UPS, DHL & E-MAX rates for outbound express shipments from Korea (ICN) — more carriers coming soon.',
    ...
    'landing.instantQuotes.desc': 'Compare UPS, DHL & E-MAX rates side by side, with more carriers being added. Calculates Door-to-Door and Door-to-Airport costs with live exchange rates and fuel surcharges.',
    'landing.accurateBreakdown': 'Transparent Cost Structure',
    'landing.accurateBreakdown.desc': 'Itemized breakdown of international freight, FSC, packing, and add-on services. Set your margin and generate client-ready quotes instantly. (Customs duties quoted separately)',
  ...
  cn: {
    ...
    'landing.subtitle': '专为WCA、MPL、EAN、JCtrans网络合作伙伴打造的韩国(ICN)出口快递报价系统。整合UPS、DHL、E-MAX运费，即时生成门到门报价，更多承运商持续接入中。',
    'landing.getStarted': '免费开始',
    'landing.featuresLabel': '货代专属核心功能',
    'landing.featuresTitle': '全球货代信赖的报价引擎',
    'landing.instantQuotes': '多承运商实时比价',
    'landing.instantQuotes.desc': '同时比较UPS、DHL、E-MAX运费，更多承运商持续增加中。结合实时汇率和燃油附加费，即时计算门到门和门到机场费率。',
    'landing.accurateBreakdown': '透明费用结构',
    'landing.accurateBreakdown.desc': '国际运费、FSC、包装费、附加服务逐项拆分。设定利润率，一键生成客户报价。（关税/清关费用另行报价）',
  ...
  ja: {
    ...
    'landing.subtitle': 'WCA・MPL・EAN・JCtransネットワークパートナー向け韓国(ICN)発輸出エクスプレス見積システム。UPS、DHL、E-MAXを統合し、Door-to-Door運賃を即時算出。キャリアは順次拡大中です。',
    ...
    'landing.instantQuotes.desc': 'UPS、DHL、E-MAXの運賃を同時比較。キャリアは順次追加されます。リアルタイム為替レートと燃料サーチャージを反映し、Door-to-DoorおよびDoor-to-Air料金を即座に計算します。',
    'landing.accurateBreakdown': '透明な費用構造',
    'landing.accurateBreakdown.desc': '国際運賃、FSC、梱包費、付加サービスを項目別に分解。マージン設定で顧客提案価格を一括算出します。（関税・通関費用は別途）',
