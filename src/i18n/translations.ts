...
export const translations: Record<Language, Record<string, string>> = {
  ko: {
     ...
     'landing.subtitle': '글로벌 포워딩 네트워크 파트너를 위한 국제 물류 견적 시스템. 멀티 캐리어 연동으로 Door-to-Door 운임을 즉시 산출하며, 캐리어는 지속 확장 중입니다.',
     ...
     'landing.instantQuotes.desc': '복수 캐리어 운임을 동시에 비교하고, 캐리어는 지속 추가됩니다. Door-to-Door, Door-to-Airport 요금을 실시간 환율과 FSC를 반영하여 즉시 계산합니다.',
  ...
  en: {
    ...
    'landing.subtitle': 'The quoting engine built for global freight network partners. Compare carrier rates with real-time FSC, packaging and Door-to-Door costs — more carriers coming soon.',
    ...
    'landing.instantQuotes.desc': 'Compare multiple carrier rates side by side, with more carriers being added. Calculates Door-to-Door and Door-to-Airport costs with live exchange rates and fuel surcharges.',
  ...
  cn: {
    ...
    'landing.subtitle': '专为全球货运网络合作伙伴打造的国际物流报价系统。整合多家承运商运费，即时生成门到门报价，更多承运商持续接入中。',
    ...
    'landing.instantQuotes.desc': '同时比较多家承运商运费，更多承运商持续增加中。结合实时汇率和燃油附加费，即时计算门到门和门到机场费率。',
  ...
  ja: {
    ...
    'landing.subtitle': 'グローバル貨物ネットワークパートナー向け国際物流見積システム。複数キャリアを統合し、Door-to-Door運賃を即時算出。キャリアは順次拡大中です。',
    ...
    'landing.instantQuotes.desc': '複数キャリアの運賃を同時比較。キャリアは順次追加されます。リアルタイム為替レートと燃料サーチャージを反映し、Door-to-DoorおよびDoor-to-Air料金を即座に計算します。',
