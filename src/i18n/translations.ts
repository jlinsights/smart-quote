...
export const translations: Record<Language, Record<string, string>> = {
  ko: {
     ...
     'landing.featuresTitle': '정확한 견적을 위한 모든 것',
     ...
     'landing.liveRates': '실시간 요율',
     'landing.globalPorts': '47개 글로벌 포트',
     'landing.stat.carriers': '운송사',
     'landing.stat.countries': '국가',
     'landing.stat.calculation': '계산 속도',
     'landing.stat.available': '서비스',
     'landing.mock.route': '서울 → 로스앤젤레스',
     'landing.mock.margin': '마진',
     'landing.footer': '© 2025 Goodman GLS & J-Ways. All rights reserved.',
  ...
  en: {
    ...
    'landing.featuresTitle': 'Everything you need for accurate quotes',
    ...
    'landing.liveRates': 'Live Rates',
    'landing.globalPorts': '47 Global Ports',
    'landing.stat.carriers': 'Carriers',
    'landing.stat.countries': 'Countries',
    'landing.stat.calculation': 'Calculation',
  ...
  cn: {
    ...
    'landing.featuresLabel': '核心功能',
    'landing.featuresTitle': '精准报价所需的一切',
    ...
    'landing.liveRates': '实时费率',
    'landing.globalPorts': '47个全球港口',
    'landing.stat.carriers': '承运商',
    'landing.stat.countries': '国家',
    'landing.stat.calculation': '计算速度',
  ...
  ja: {
    ...
    'landing.featuresLabel': '主な機能',
    'landing.featuresTitle': '正確な見積に必要なすべて',
    ...
    'landing.liveRates': 'リアルタイム料金',
    'landing.globalPorts': '47のグローバルポート',
    'landing.stat.carriers': 'キャリア',
    'landing.stat.countries': '対応国',
    'landing.stat.calculation': '計算速度',
