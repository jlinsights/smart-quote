...
export const translations: Record<Language, Record<string, string>> = {
  ko: {
     ...
     'landing.instantQuotes.desc': 'Door-to-Door, Door-to-Airport 요금을 실시간 환율과 FSC를 반영하여 즉시 계산합니다. 캐리어별 비교로 최적 운임을 확인하세요.',
     ...
     'landing.verifiedCarriers.desc': '실제 캐리어 운임 구조에 기반한 정확한 요금 산출. 포장비, 부가서비스까지 포함한 올인원 견적을 제공합니다.',
  ...
  en: {
    ...
    'landing.instantQuotes.desc': 'Calculate Door-to-Door and Door-to-Airport costs with live exchange rates and fuel surcharges. Compare carriers side by side to find the best rate.',
    ...
    'landing.verifiedCarriers.desc': 'Accurate pricing based on actual carrier rate structures. All-in-one quotes including packing, add-on services, and Door-to-Door costs.',
  ...
  cn: {
    ...
    'landing.subtitle': '专为货运合作伙伴打造的国际特快报价系统。结合实时汇率和FSC，即时生成门到门运费报价。',
    'landing.getStarted': '免费开始',
    'landing.featuresLabel': '货代专属核心功能',
    'landing.featuresTitle': '为网络合作伙伴打造的智能报价方案',
    'landing.instantQuotes': '即时运费报价',
    'landing.instantQuotes.desc': '结合实时汇率和燃油附加费，即时计算门到门和门到机场费率。对比承运商报价，找到最优运费方案。',
    ...
    'landing.verifiedCarriers.desc': '基于真实承运商费率结构的精确定价。包含包装费、附加服务的一站式报价。',
  ...
  ja: {
    ...
    'landing.subtitle': 'フォワーディングパートナー向け国際エクスプレス見積システム。リアルタイム為替レートとFSCを反映し、Door-to-Door運賃を即時算出します。',
    ...
    'landing.instantQuotes.desc': 'リアルタイム為替レートと燃料サーチャージを反映し、Door-to-DoorおよびDoor-to-Air料金を即座に計算。キャリア比較で最適運賃を確認できます。',
    ...
    'landing.verifiedCarriers.desc': '実際のキャリア料金構造に基づく正確な価格算出。梱包費・付加サービスを含むオールインワン見積を提供します。',
