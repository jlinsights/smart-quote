          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 sm:pt-32 sm:pb-40 lg:pt-40 lg:pb-48">
            <div className="text-center">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-8">
                ...
                <span className="text-xs sm:text-sm font-medium text-cyan-300 tracking-wide">
              ...
              {!isAuthenticated && (
                <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    to="/signup"
                    className="group inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-cyan-600 hover:bg-cyan-500 text-white text-base font-semibold rounded-xl shadow-lg shadow-cyan-600/25 hover:shadow-cyan-500/30 transition-all duration-200"
                  >
